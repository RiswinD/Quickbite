...
<html lang="en">
 ...
 <head>
  ...
  <title>QuickBite - Premium Veg Curries</title>
...
<body>
  ...
  <main class="menu-main curry-main">
    <!-- Hero Section -->
    <div class="menu-hero curry-hero" style="--hero-image: url('../images/vegcurry-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title"
            data-lang-en="Authentic Veg Curries"
            data-lang-ta="உண்மையான சைவ கறிகள்"
            data-lang-hi="प्रामाणिक वेज करी">
          Authentic Veg Curries
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Enjoy the rich taste of Indian vegetarian curries"
           data-lang-ta="இந்திய சைவ கறிகளின் செழுமையான சுவையை அனுபவிக்கவும்"
           data-lang-hi="भारतीय शाकाहारी करी के समृद्ध स्वाद का आनंद लें">
          Enjoy the rich taste of Indian vegetarian curries
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        <button class="tab-btn active" data-category="all">
          ...
          <span data-lang-en="All Curries" data-lang-ta="அனைத்து கறிகள்" data-lang-hi="सभी करी">All Curries</span>
        </button>
        <button class="tab-btn" data-category="paneer special">
          <i class="fas fa-cheese"></i>
          <span data-lang-en="Paneer" data-lang-ta="பனீர்" data-lang-hi="पनीर">Paneer</span>
        </button>
        <button class="tab-btn" data-category="vegetable">
          <i class="fas fa-carrot"></i>
          <span data-lang-en="Vegetable" data-lang-ta="காய்கறி" data-lang-hi="सब्ज़ी">Vegetable</span>
        </button>
      ...
      <div class="menu-grid">
        ...
        <article class="menu-card" data-category="paneer special">
          ...
          <div class="card-image">
            <img src="../images/paneerbuttermasala.jpg" alt="Paneer Butter Masala" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Paneer Butter Masala" data-lang-ta="பனீர் பட்டர் மசாலா" data-lang-hi="पनीर बटर मसाला">Paneer Butter Masala</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.9</span>
            ...
            <p class="card-description" data-lang-en="Delicious paneer in a rich creamy tomato sauce"
               data-lang-ta="க்ரீமி தக்காளி சாஸ் மற்றும் பனீர்"
               data-lang-hi="क्रीमी टमाटर सॉस में स्वादिष्ट पनीर">
              Delicious paneer in a rich creamy tomato sauce
            </p>
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="250"
                        data-image="../images/paneerbuttermasala.jpg">
                  <i class="fas fa-shopping-cart"></i>
        ...
        <article class="menu-card" data-category="vegetable">
          <div class="card-image">
            <img src="../images/mixedvegetablecurry.jpg" alt="Mixed Vegetable Curry" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Mixed Vegetable Curry" data-lang-ta="மிக்சட் காய்கறி கறி" data-lang-hi="मिक्स वेज करी">Mixed Vegetable Curry</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="A medley of fresh vegetables cooked in a flavorful gravy"
               data-lang-ta="சுவையான கிரேவியில் பசுவைப் பழங்களின் கலவை"
               data-lang-hi="स्वादिष्ट ग्रेवी में ताजगी से भरपूर सब्जियां">
              A medley of fresh vegetables cooked in a flavorful gravy
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="32"
                        data-name="Mixed Vegetable Curry"
                        data-price="200"
                        data-image="../images/mixedvegetablecurry.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="vegetable">
          ...
          <div class="card-image">
            <img src="../images/aloogobi.jpg" alt="Aloo Gobi" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Aloo Gobi" data-lang-ta="ஆலூ கோபி" data-lang-hi="आलू गोभी">Aloo Gobi</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.5</span>
            ...
            <p class="card-description" data-lang-en="Potatoes and cauliflower cooked with Indian spices"
               data-lang-ta="இந்திய மசாலா வற்றிய கிழங்கும், கோபியும்"
               data-lang-hi="आलू और गोभी भारतीय मसालों के साथ पकाया हुआ">
            ...
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-name="Aloo Gobi"
                        data-price="180"
                        data-image="../images/aloogobi.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="vegetable">
          <div class="card-image">
            <img src="../images/bainganbharta.jpg" alt="Baingan Bharta" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Baingan Bharta" data-lang-ta="பாயங்கான் பர்த்தா" data-lang-hi="बैंगन भर्ता">Baingan Bharta</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.4</span>
            ...
            <p class="card-description" data-lang-en="Smoky mashed eggplant cooked with onions and tomatoes"
               data-lang-ta="உருளைக்கிழங்கு மற்றும் தக்காளி உடன் பருப்புக் காய்கறி"
               data-lang-hi="स्मोकी बैंगन जो प्याज और टमाटर के साथ पकाया गया">
              Smoky mashed eggplant cooked with onions and tomatoes
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="34"
                        data-name="Baingan Bharta"
                        data-price="220"
                        data-image="../images/bainganbharta.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="vegetable">
          <div class="card-badge healthy" data-lang-en="Healthy" data-lang-ta="ஆரோக்கியம்" data-lang-hi="स्वास्थ्य">Healthy</div>
          <div class="card-image">
            <img src="../images/channamasala.jpg" alt="Chana Masala" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Chana Masala" data-lang-ta="சணா மசாலா" data-lang-hi="चना मसाला">Chana Masala</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="Chickpeas cooked in a spicy tomato-based gravy"
               data-lang-ta="சுவையான தக்காளி கிரேவியில் சணா காய்கள்"
               data-lang-hi="स्पाइसी टमाटर ग्रेवी में छोले">
              Chickpeas cooked in a spicy tomato-based gravy
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="35"
                        data-name="Chana Masala"
                        data-price="150"
                        data-image="../images/channamasala.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
  ...
  <!-- Quick View Modal, Cart Sidebar, and Footer are same as previous pages (use your template) -->

  <!-- Script for Veg Curry Page -->
<script>
  // DOM Elements
  ...
  // Product data for quick view modal (Veg Curry Page)
  const products = {
    31: {
    ...
    32: {
      ...
      image: "../images/mixedvegetablecurry.jpg",
      price: 200,
      rating: 4.6,
      reviews: 187,
