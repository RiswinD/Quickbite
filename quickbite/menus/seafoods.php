...
<head>
  ...
  <title>QuickBite - Seafood Specials</title>
...
<body>
  ...
  <main class="menu-main seafood-main">
    <!-- Hero Section -->
    <div class="menu-hero seafood-hero" style="--hero-image: url('../images/seafood-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title"
            data-lang-en="Seafood Specials"
            data-lang-ta="கடல் உணவு சிறப்புகள்"
            data-lang-hi="सीफूड स्पेशल">
          Seafood Specials
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Fresh from the ocean – spicy, tangy, and full of flavor"
           data-lang-ta="கடல் சுவைகள் – காரம், புளிப்பு, சுவை நிரம்பியவை"
           data-lang-hi="समुद्र से ताजा – मसालेदार, खट्टा और स्वाद से भरपूर">
          Fresh from the ocean – spicy, tangy, and full of flavor
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        ...
        <button class="tab-btn" data-category="fish">
          <i class="fas fa-fish"></i>
          <span data-lang-en="Fish" data-lang-ta="மீன்" data-lang-hi="मछली">Fish</span>
        </button>
        <button class="tab-btn" data-category="prawn">
          <i class="fas fa-shrimp"></i>
          <span data-lang-en="Prawn" data-lang-ta="இறால்" data-lang-hi="झींगा">Prawn</span>
        </button>
        <button class="tab-btn" data-category="special">
          <i class="fas fa-gem"></i>
          <span data-lang-en="Crab & Special" data-lang-ta="நண்டு & சிறப்பு" data-lang-hi="केकड़ा और स्पेशल">Crab & Special</span>
        </button>
        <button class="tab-btn" data-category="other">
          <i class="fas fa-water"></i>
          <span data-lang-en="Others" data-lang-ta="மற்றவை" data-lang-hi="अन्य">Others</span>
        </button>
      </div>
      ...
      <div class="menu-grid">
        <!-- Fish Fry -->
        <article class="menu-card" data-category="fish">
          ...
          <div class="card-content">
            ...
            <p class="card-description" data-lang-en="Crispy fried fish with coastal spices"
               data-lang-ta="கரையோர சுவைகளுடன் குருமணக்கும் மீன் வறுவல்"
               data-lang-hi="तटीय मसालों के साथ कुरकुरी मछली फ्राई">
        ...
        <!-- Prawn Masala -->
        <article class="menu-card" data-category="prawn">
          <div class="card-image">
            <img src="../images/Prawn Masala.jpeg" alt="Prawn Masala" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Prawn Masala" data-lang-ta="இறால் மசாலா" data-lang-hi="प्रॉन मसाला">Prawn Masala</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="Juicy prawns cooked in rich masala gravy"
               data-lang-ta="ருசிகர மசாலாவில் சமைக்கப்பட்ட இறால்"
               data-lang-hi="मसालेदार ग्रेवी में पकी रसीली झींगे">
              Juicy prawns cooked in rich masala gravy
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="85"
                        data-name="Prawn Masala"
                        data-price="350"
                        data-image="../images/Prawn Masala.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="special">
          ...
          <div class="card-image">
            <img src="../images/Crab Roast.jpg" alt="Crab Roast" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Crab Roast" data-lang-ta="நண்டு வறுவல்" data-lang-hi="केकड़ा रोस्ट">Crab Roast</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.9</span>
            ...
            <p class="card-description" data-lang-en="Spicy and flavorful roasted crab"
               data-lang-ta="சுவை மிகுந்த நண்டு வறுவல்"
               data-lang-hi="मसालेदार और स्वादिष्ट केकड़ा रोस्ट">
              Spicy and flavorful roasted crab
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="86"
                        data-name="Crab Roast"
                        data-price="400"
                        data-image="../images/Crab Roast.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="fish">
          <div class="card-image">
            <img src="../images/Fish Curry.jpg" alt="Fish Curry" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Fish Curry" data-lang-ta="மீன் குழம்பு" data-lang-hi="फिश करी">Fish Curry</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="Traditional South Indian fish curry with tangy tamarind"
               data-lang-ta="புளிச்சருப்பான தென்னிந்திய மீன் குழம்பு"
               data-lang-hi="खट्टी इमली वाली पारंपरिक दक्षिण भारतीय मछली करी">
              Traditional South Indian fish curry with tangy tamarind
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="280"
                        data-image="../images/Fish Curry.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="prawn">
          ...
          <div class="card-image">
            <img src="../images/Prawn 65.jpeg" alt="Prawn 65" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Prawn 65" data-lang-ta="இறால் 65" data-lang-hi="प्रॉन 65">Prawn 65</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
            ...
            <p class="card-description" data-lang-en="Spicy deep-fried prawn appetizer"
               data-lang-ta="மிளகாய் மசாலாவில் Dip பண்ணி வறுத்த இறால் ஸ்னாக்"
               data-lang-hi="मसालेदार डीप फ्राई की गई झींगा स्टार्टर">
              Spicy deep-fried prawn appetizer
            </p>
            <div class="card-footer">
              <div class="price">
                <span class="current-price">₹350</span>
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-name="Prawn 65"
                        data-price="350"
                        data-image="../images/Prawn 65.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
