...
<head>
  ...
  <title>QuickBite - Authentic Indian Breads</title>
...
<body>
  ...
  <main class="menu-main bread-main">
    <!-- Hero Section -->
    <div class="menu-hero bread-hero" style="--hero-image: url('../images/indianbread-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title"
            data-lang-en="Discover Authentic Indian Breads"
            data-lang-ta="உண்மையான இந்திய ரொட்டிகளை கண்டறியவும்"
            data-lang-hi="प्रामाणिक भारतीय ब्रेड की खोज करें">
          Discover Authentic Indian Breads
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Experience the variety and flavors of India's bread culture"
           data-lang-ta="இந்தியாவின் ரொட்டி பாரம்பரியத்தின் பல்வகை சுவைகளை அனுபவிக்கவும்"
           data-lang-hi="भारत की ब्रेड संस्कृति के विविधता और स्वाद का अनुभव करें">
          Experience the variety and flavors of India's bread culture
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        <button class="tab-btn active" data-category="all">
          ...
          <span data-lang-en="All Breads" data-lang-ta="அனைத்து ரொட்டிகள்" data-lang-hi="सभी ब्रेड">All Breads</span>
        </button>
        <button class="tab-btn" data-category="tandoori special">
          <i class="fas fa-fire"></i>
          <span data-lang-en="Tandoori Special" data-lang-ta="தண்டூரி சிறப்பு" data-lang-hi="तंदूरी स्पेशल">Tandoori Special</span>
        </button>
        <button class="tab-btn" data-category="tandoori">
          <i class="fas fa-burn"></i>
          <span data-lang-en="Tandoori" data-lang-ta="தண்டூரி" data-lang-hi="तंदूरी">Tandoori</span>
        </button>
        <button class="tab-btn" data-category="fried">
          <i class="fas fa-oil-can"></i>
          <span data-lang-en="Fried" data-lang-ta="வறுக்கப்பட்ட" data-lang-hi="तली हुई">Fried</span>
        </button>
        <button class="tab-btn" data-category="fried special">
          <i class="fas fa-star"></i>
          <span data-lang-en="Fried Special" data-lang-ta="வறுக்கப்பட்ட சிறப்பு" data-lang-hi="तली हुई स्पेशल">Fried Special</span>
        </button>
      </div>
      ...
      <div class="menu-grid">
        ...
        <!-- Roti -->
        <article class="menu-card" data-category="tandoori">
          <div class="card-image">
            <img src="../images/roti.jpeg" alt="Roti" loading="lazy">
            <button class="quick-view-btn" data-id="39">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Roti" data-lang-ta="ரோட்டி" data-lang-hi="रोटी">Roti</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.5</span>
                <span class="review-count">(185)</span>
              </div>
            </div>
            <p class="card-description" data-lang-en="Traditional Indian whole wheat flatbread"
               data-lang-ta="பாரம்பரிய இந்திய முழு கோதுமை அட்டைப் பருப்பு"
               data-lang-hi="पारंपरिक भारतीय गेहूं की रोटी">
              Traditional Indian whole wheat flatbread
            </p>
            <div class="card-footer">
              <div class="price">
        ...
        <article class="menu-card" data-category="fried">
          <div class="card-image">
            ...
            <button class="quick-view-btn" data-id="40">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Paratha" data-lang-ta="பராதா" data-lang-hi="पराठा">Paratha</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="Flaky, crispy flatbread served with yogurt or pickles"
               data-lang-ta="சுத்திய மற்றும் கறிக்கோழியுடன் பரிமாறப்படும் மந்தலுக்கு பராதா"
               data-lang-hi="कुरकुरी, परतदार रोटी दही या अचार के साथ सर्व की जाती है">
              Flaky, crispy flatbread served with yogurt or pickles
            </p>
            <div class="card-footer">
              <div class="price">
        ...
        <article class="menu-card" data-category="tandoori">
          ...
          <div class="card-image">
            <img src="../images/thandooriroti.jpeg" alt="Tandoori Roti" loading="lazy">
            <button class="quick-view-btn" data-id="41">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Tandoori Roti" data-lang-ta="தண்டூரி ரோட்டி" data-lang-hi="तंदूरी रोटी">Tandoori Roti</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="A smoky and crispy roti made in a traditional tandoor oven"
               data-lang-ta="ஒரு பாரம்பரிய தண்டூரில் தயாரிக்கப்பட்ட புகை மற்றும் வெண்ணெய் ரோட்டி"
               data-lang-hi="एक पारंपरिक तंदूर में बनी हुई धूम्रपान और कुरकुरी रोटी">
              A smoky and crispy roti made in a traditional tandoor oven
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="41"
                        data-name="Tandoori Roti"
                        data-price="100"
                        data-image="../images/thandooriroti.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="fried special">
          <div class="card-badge popular" data-lang-en="Popular" data-lang-ta="பிரபலமான" data-lang-hi="लोकप्रिय">Popular</div>
          <div class="card-image">
            <img src="../images/bhature.jpg" alt="Bhature" loading="lazy">
            <button class="quick-view-btn" data-id="44">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Bhature" data-lang-ta="பட்டூர்" data-lang-hi="भटूरा">Bhature</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
                <span class="review-count">(205)</span>
              </div>
            </div>
            <p class="card-description" data-lang-en="Fluffy and deep-fried bread, perfect with chole"
               data-lang-ta="சோலேக்காக சிறந்தது, மேலே உயர்ந்த பொரித்த ரொட்டி"
               data-lang-hi="छोले के साथ परफेक्ट, फूली और डीप फ्राई की हुई रोटी">
              Fluffy and deep-fried bread, perfect with chole
            </p>
            <div class="card-footer">
              <div class="price">
  ...
  const products = {
    ...
    41: {
      ...
      nameHi: "तंदूरी रोटी",
      image: "../images/thandooriroti.jpeg",
      price: 100,
      rating: 4.7,
      reviews: 192,
      badge: "Healthy",
