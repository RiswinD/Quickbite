...
<head>
  ...
  <title>QuickBite - Premium Milkshakes</title>
...
<body>
  ...
  <main class="menu-main milkshake-main">
    <!-- Hero Section -->
    <div class="menu-hero milkshake-hero" style="--hero-image: url('../images/milkshake-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title" 
            data-lang-en="Delicious Creamy Milkshakes"
            data-lang-ta="ருசிகரமான கிரீமி மில்க்ஷேக்குகள்"
            data-lang-hi="स्वादिष्ट क्रीमी मिल्कशेक">
          Delicious Creamy Milkshakes
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Experience the rich, creamy goodness of our handcrafted milkshakes"
           data-lang-ta="எங்கள் கைவினை மில்க்ஷேக்குகளின் செழுமையான, கிரீமி நறுமணத்தை அனுபவிக்கவும்"
           data-lang-hi="हमारे हस्तनिर्मित मिल्कशेक की समृद्ध, मलाईदार अच्छाई का अनुभव करें">
          Experience the rich, creamy goodness of our handcrafted milkshakes
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        <button class="tab-btn active" data-category="all">
          ...
          <span data-lang-en="All Milkshakes" data-lang-ta="அனைத்து மில்க்ஷேக்குகள்" data-lang-hi="सभी मिल्कशेक">All Milkshakes</span>
        </button>
        <button class="tab-btn" data-category="fruity">
          <i class="fas fa-apple-alt"></i>
          <span data-lang-en="Fruity" data-lang-ta="பழங்கள்" data-lang-hi="फ्रूटी">Fruity</span>
        </button>
        <button class="tab-btn" data-category="classic">
          <i class="fas fa-ice-cream"></i>
          <span data-lang-en="Classic" data-lang-ta="கிளாசிக்" data-lang-hi="क्लासिक">Classic</span>
        </button>
        <button class="tab-btn" data-category="premium">
          <i class="fas fa-crown"></i>
          <span data-lang-en="Premium" data-lang-ta="பிரீமியம்" data-lang-hi="प्रीमियम">Premium</span>
        </button>
      </div>
      ...
      <div class="menu-grid">
        ...
        <article class="menu-card" data-category="fruity">
          <div class="card-badge popular" data-lang-en="Popular" data-lang-ta="பிரபலமான" data-lang-hi="लोकप्रिय">Popular</div>
          <div class="card-image">
            <img src="../images/strawberrymilkshake.webp" alt="Strawberry Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="12">
          ...
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Strawberry Milkshake" data-lang-ta="ஸ்ட்ராபெரி மில்க்ஷேக்" data-lang-hi="स्ट्रॉबेरी मिल्कशेक">Strawberry Milkshake</h3>
              <div class="rating">
            ...
            <p class="card-description" data-lang-en="A refreshing milkshake made with strawberries"
               data-lang-ta="ஸ்ட்ராபெரி கொண்டு செய்யப்பட்ட புதுமையான மில்க்ஷேக்"
               data-lang-hi="स्ट्रॉबेरी से बनी ताजगी से भरपूर मिल्कशेक">
              A refreshing milkshake made with strawberries
            </p>
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="80"
                        data-image="../images/strawberrymilkshake.webp">
                  <i class="fas fa-shopping-cart"></i>
        ...
        <!-- Vanilla Milkshake -->
        <article class="menu-card" data-category="classic">
          <div class="card-image">
            <img src="../images/vanillamilkshake.jpg" alt="Vanilla Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="13">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Vanilla Milkshake" data-lang-ta="வனிலா மில்க்ஷேக்" data-lang-hi="वनीला मिल्कशेक">Vanilla Milkshake</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.5</span>
            ...
            <p class="card-description" data-lang-en="A smooth and creamy milkshake made with vanilla flavor"
               data-lang-ta="வனிலா சுவையுடன் செய்யப்பட்ட மில்க்ஷேக்"
               data-lang-hi="वनीला फ्लेवर से बनी मुलायम और क्रीमी मिल्कशेक">
              A smooth and creamy milkshake made with vanilla flavor
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="13"
                        data-name="Vanilla Milkshake"
                        data-price="70"
                        data-image="../images/vanillamilkshake.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <!-- Mango Milkshake -->
        <article class="menu-card" data-category="fruity">
          <div class="card-badge seasonal" data-lang-en="Seasonal" data-lang-ta="பருவகால" data-lang-hi="मौसमी">Seasonal</div>
          <div class="card-image">
            <img src="../images/mangomilkshake.jpeg" alt="Mango Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="14">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Mango Milkshake" data-lang-ta="மாங்காய் மில்க்ஷேக்" data-lang-hi="आम मिल्कशेक">Mango Milkshake</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.9</span>
            ...
            <p class="card-description" data-lang-en="A tropical milkshake made with ripe mangoes"
               data-lang-ta="பழம் காய்ந்த மாங்காயுடன் செய்யபட்ட மில்க்ஷேக்"
               data-lang-hi="पके हुए आम से बनी उष्णकटिबंधीय मिल्कशेक">
              A tropical milkshake made with ripe mangoes
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="14"
                        data-name="Mango Milkshake"
                        data-price="75"
                        data-image="../images/mangomilkshake.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="fruity">
          ...
          <div class="card-image">
            <img src="../images/bananamilkshake.jpeg" alt="Banana Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="15">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Banana Milkshake" data-lang-ta="வாழை மில்க்ஷேக்" data-lang-hi="केला मिल्कशेक">Banana Milkshake</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="A nutritious milkshake with fresh bananas"
               data-lang-ta="புதிய வாழைப்பழங்களுடன் ஊட்டச்சத்து மிக்க மில்க்ஷேக்"
               data-lang-hi="ताजे केले से बना पौष्टिक मिल्कशेक">
              A nutritious milkshake with fresh bananas
            </p>
            <div class="card-footer">
              <div class="price">
                <span class="current-price">₹75</span>
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="15"
                        data-name="Banana Milkshake"
                        data-price="75"
                        data-image="../images/bananamilkshake.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="classic">
          <div class="card-image">
            <img src="../images/coffeemilkshake.jpeg" alt="Coffee Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="16">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Coffee Milkshake" data-lang-ta="காப்பி மில்க்ஷேக்" data-lang-hi="कॉफी मिल्कशेक">Coffee Milkshake</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="A coffee-flavored milkshake for coffee lovers"
               data-lang-ta="காப்பி ஆர்வலர்களுக்கான காப்பி சுவை மில்க்ஷேக்"
               data-lang-hi="कॉफी प्रेमियों के लिए एक कॉफी फ्लेवर मिल्कशेक">
              A coffee-flavored milkshake for coffee lovers
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="16"
                        data-name="Coffee Milkshake"
                        data-price="85"
                        data-image="../images/coffeemilkshake.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="premium">
          <div class="card-image">
            <img src="../images/peanutbuttermilkshake.jpeg" alt="Peanut Butter Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="18">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Peanut Butter Milkshake" data-lang-ta="பீனட் பட்டர் மில்க்ஷேக்" data-lang-hi="पीनट बटर मिल्कशेक">Peanut Butter Milkshake</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="A creamy milkshake made with peanut butter"
               data-lang-ta="பீனட் பட்டருடன் செய்யபட்ட கிரீமி மில்க்ஷேக்"
               data-lang-hi="पीनट बटर से बनी क्रीमी मिल्कशेक">
              A creamy milkshake made with peanut butter
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="18"
                        data-name="Peanut Butter Milkshake"
                        data-price="100"
                        data-image="../images/peanutbuttermilkshake.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="fruity">
          <div class="card-image">
            <img src="../images/kivimilkshake.webp" alt="Kiwi Milkshake" loading="lazy">
            <button class="quick-view-btn" data-id="19">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Kiwi Milkshake" data-lang-ta="கிவி மில்க்ஷேக்" data-lang-hi="कीवी मिल्कशेक">Kiwi Milkshake</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.5</span>
            ...
            <p class="card-description" data-lang-en="A tangy milkshake made with fresh kiwi fruit"
               data-lang-ta="புதிய கிவி பழத்துடன் செய்யப்பட்ட புளிப்பான மில்க்ஷேக்"
               data-lang-hi="ताजे कीवी फल से बनी एक खट्टी मिल्कशेक">
              A tangy milkshake made with fresh kiwi fruit
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="19"
                        data-name="Kiwi Milkshake"
                        data-price="90"
                        data-image="../images/kivimilkshake.webp">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
  ...
  <script>
    ...
    const products = {
      12: {
        ...
        image: "../images/strawberrymilkshake.webp",
        price: 80,
        rating: 4.8,
        reviews: 145,
        badge: "Popular",
      ...
      16: {
        ...
        image: "../images/coffeemilkshake.jpeg",
        price: 85,
        rating: 4.7,
        reviews: 156,
      ...
      18: {
        ...
        image: "../images/peanutbuttermilkshake.jpeg",
        price: 100,
        rating: 4.6,
        reviews: 112,
      ...
      19: {
        ...
        image: "../images/kivimilkshake.webp",
        price: 90,
        rating: 4.5,
        reviews: 89,
