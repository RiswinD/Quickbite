...
<head>
  ...
  <title>QuickBite - Fresh Juices</title>
...
<body>
  ...
  <main class="menu-main juice-main">
    <!-- Hero Section -->
    <div class="menu-hero juice-hero" style="--hero-image: url('../images/juice-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title" 
            data-lang-en="Fresh & Healthy Juices"
            data-lang-ta="புதிய & ஆரோக்கியமான பழச்சாறுகள்"
            data-lang-hi="ताजा और स्वास्थ्यवर्धक जूस">
          Fresh & Healthy Juices
        </h1>
        <p class="hero-subtitle"
           data-lang-en="100% natural juices packed with vitamins and nutrients"
           data-lang-ta="வைட்டமின்கள் மற்றும் ஊட்டச்சத்துக்கள் நிறைந்த 100% இயற்கை சாறுகள்"
           data-lang-hi="विटामिन और पोषक तत्वों से भरपूर 100% प्राकृतिक रस">
          100% natural juices packed with vitamins and nutrients
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        <button class="tab-btn active" data-category="all">
          ...
          <span data-lang-en="All Juices" data-lang-ta="அனைத்து சாறுகள்" data-lang-hi="सभी जूस">All Juices</span>
        </button>
        <button class="tab-btn" data-category="fruit">
          <i class="fas fa-apple-whole"></i>
          <span data-lang-en="Fruit Juices" data-lang-ta="பழச்சாறுகள்" data-lang-hi="फलों का रस">Fruit Juices</span>
        </button>
        <button class="tab-btn" data-category="vegetable">
          <i class="fas fa-carrot"></i>
          <span data-lang-en="Vegetable Juices" data-lang-ta="காய்கறி சாறுகள்" data-lang-hi="सब्जियों का रस">Vegetable Juices</span>
        </button>
        <button class="tab-btn" data-category="special">
          <i class="fas fa-star"></i>
          <span data-lang-en="Special Juices" data-lang-ta="சிறப்பு சாறுகள்" data-lang-hi="विशेष जूस">Special Juices</span>
        </button>
      </div>
      ...
      <div class="menu-grid">
        ...
        <article class="menu-card" data-category="fruit">
          ...
          <div class="card-image">
            <img src="../images/orangejuice.webp" alt="Orange Juice" loading="lazy">
            <button class="quick-view-btn" data-id="20">
          ...
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Orange Juice" data-lang-ta="ஆரஞ்சு ஜூஸ்" data-lang-hi="संतरा जूस">Orange Juice</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
            ...
            <p class="card-description" data-lang-en="Freshly squeezed orange juice"
               data-lang-ta="புதிய ஆரஞ்சு பழச் சாறு"
               data-lang-hi="ताजा संतरे का रस">
            ...
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="85"
                        data-image="../images/orangejuice.webp">
                  <i class="fas fa-shopping-cart"></i>
        ...
        <article class="menu-card" data-category="fruit">
          ...
          <div class="card-image">
            <img src="../images/watermelonjuice.jpg" alt="Watermelon Juice" loading="lazy">
            <button class="quick-view-btn" data-id="21">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Watermelon Juice" data-lang-ta="தர்பூசணி ஜூஸ்" data-lang-hi="तरबूज जूस">Watermelon Juice</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="Cool and hydrating summer drink"
               data-lang-ta="குளிர்ச்சியும் நீர்ச்சியும் தரும் குடிநீர்"
               data-lang-hi="गर्मी में ठंडक देने वाला पेय">
              Cool and hydrating summer drink
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="21"
                        data-name="Watermelon Juice"
                        data-price="70"
                        data-image="../images/watermelonjuice.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="fruit">
          <div class="card-image">
            <img src="../images/pineapplejuice.jpeg" alt="Pineapple Juice" loading="lazy">
            <button class="quick-view-btn" data-id="22">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Pineapple Juice" data-lang-ta="அன்னாசி ஜூஸ்" data-lang-hi="अनानास जूस">Pineapple Juice</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="Tangy and sweet tropical delight"
               data-lang-ta="கசப்பு மற்றும் இனிப்பின் ஒருங்கிணைப்பு"
               data-lang-hi="खट्टा-मीठा उष्णकटिबंधीय पेय">
              Tangy and sweet tropical delight
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="90"
                        data-image="../images/pineapplejuice.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="fruit">
          <div class="card-badge seasonal" data-lang-en="Seasonal" data-lang-ta="பருவகால" data-lang-hi="मौसमी">Seasonal</div>
          <div class="card-image">
            <img src="../images/mangojuice.jpeg" alt="Mango Juice" loading="lazy">
            <button class="quick-view-btn" data-id="25">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Mango Juice" data-lang-ta="மாம்பழம் ஜூஸ்" data-lang-hi="आम का जूस">Mango Juice</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.9</span>
            ...
            <p class="card-description" data-lang-en="Sweet and tangy summer favorite"
               data-lang-ta="இனிப்பு மற்றும் கசப்பின் கலவை"
               data-lang-hi="मीठा और खट्टा ग्रीष्मकालीन पसंदीदा">
              Sweet and tangy summer favorite
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="25"
                        data-name="Mango Juice"
                        data-price="95"
                        data-image="../images/mangojuice.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <!-- Carrot Juice -->
        <article class="menu-card" data-category="vegetable">
          <div class="card-badge healthy" data-lang-en="Healthy" data-lang-ta="ஆரோக்கியம்" data-lang-hi="स्वास्थ्य">Healthy</div>
          <div class="card-image">
            <img src="../images/carrotjuice.jpeg" alt="Carrot Juice" loading="lazy">
            <button class="quick-view-btn" data-id="26">
              <i class="fas fa-search-plus"></i>
              <span data-lang-en="Quick View" data-lang-ta="விரைவான பார்வை" data-lang-hi="त्वरित दृश्य">Quick View</span>
            </button>
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Carrot Juice" data-lang-ta="கேரட் ஜூஸ்" data-lang-hi="गाजर का रस">Carrot Juice</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="Nutritious and naturally sweet"
               data-lang-ta="ஊட்டச்சத்து நிறைந்த இனிப்பு சாறு"
               data-lang-hi="स्वस्थ और मीठा जूस">
              Nutritious and naturally sweet
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="80"
                        data-image="../images/carrotjuice.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
  ...
  <script>
    ...
    const products = {
      ...
      22: {
        ...
        nameTa: "அன்னாசி ஜூஸ்",
        nameHi: "अनानास जूस",
        image: "../images/pineapplejuice.jpeg",
        price: 90,
        rating: 4.7,
        reviews: 118,
      ...
      23: {
        ...
        nameTa: "மாதுளை ஜூஸ்",
        nameHi: "अनार का रस",
        image: "../images/pomegranatejuice.jpeg",
        price: 100,
        rating: 4.9,
        reviews: 156,
        badge: "Healthy",
      ...
      27: {
        name: "Beetroot Juice",
        nameTa: "பீட்ரூட் ஜூஸ்",
        nameHi: "चुकंदर का रस",
        image: "../images/beetrootjuice.jpeg",
        price: 90,
        rating: 4.4,
        reviews: 87,
        description: "Energy boosting and detoxifying",
        descriptionTa: "ஆற்றல் மற்றும் நச்சுத்தன்மை நீக்கும்",
        descriptionHi: "ऊर्जा बढ़ाने वाला और डिटॉक्स करने वाला"
      }
    };
