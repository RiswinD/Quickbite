...
<head>
  ...
  <title>QuickBite - Biryanis & Specials</title>
...
<body>
  ...
  <main class="menu-main biryanis-main">
    <!-- Hero Section -->
    <div class="menu-hero biryanis-hero" style="--hero-image: url('../images/biryani-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title"
            data-lang-en="Signature Biryanis & Specials"
            data-lang-ta="சிறந்த பிரியாணி வகைகள்"
            data-lang-hi="स्पेशल बिरयानी और विशेष व्यंजन">
          Signature Biryanis & Specials
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Experience the royal taste of tradition and spice"
           data-lang-ta="பாரம்பரியமும் மசாலாவும் கலந்த சுவையை அனுபவிக்கவும்"
           data-lang-hi="परंपरा और मसालों का शाही स्वाद अनुभव करें">
          Experience the royal taste of tradition and spice
        </p>
      </div>
      ...
      <div class="menu-grid">
        ...
        <article class="menu-card" data-category="chicken">
          ...
          <div class="card-image">
            <img src="../images/Chicken Biryani.jpg" alt="Chicken Biryani" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Chicken Biryani" data-lang-ta="சிக்கன் பிரியாணி" data-lang-hi="चिकन बिरयानी">Chicken Biryani</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.9</span>
                <span class="review-count">(285)</span>
              </div>
            </div>
            <p class="card-description" data-lang-en="Fragrant rice cooked with spiced chicken"
               data-lang-ta="சுவையான சிக்கனுடன் வாசனை மிக்க அரிசி"
               data-lang-hi="मसालेदार चिकन के साथ सुगंधित चावल">
              Fragrant rice cooked with spiced chicken
            </p>
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="250"
                        data-image="../images/Chicken Biryani.jpg">
                  <i class="fas fa-shopping-cart"></i>
        ...
        <article class="menu-card" data-category="mutton special">
          ...
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Mutton Biryani" data-lang-ta="மட்டன் பிரியாணி" data-lang-hi="मटन बिरयानी">Mutton Biryani</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
            ...
            <p class="card-description" data-lang-en="Slow-cooked mutton with aromatic spices"
               data-lang-ta="அரோமேடிக் மசாலாவுடன் மெல்லச் சமைக்கப்பட்ட மட்டன்"
               data-lang-hi="धीमी आंच पर पकाया गया मसालेदार मटन">
              Slow-cooked mutton with aromatic spices
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="300"
                        data-image="../images/Mutton Biryani.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="chicken">
          ...
          <div class="card-image">
            <img src="../images/Egg Biryani.jpeg" alt="Egg Biryani" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Egg Biryani" data-lang-ta="முட்டை பிரியாணி" data-lang-hi="अंडा बिरयानी">Egg Biryani</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="Delicious biryani with boiled eggs and spices"
               data-lang-ta="முட்டை மற்றும் மசாலாவுடன் சுவையான பிரியாணி"
               data-lang-hi="उबले अंडों और मसालों के साथ स्वादिष्ट बिरयानी">
              Delicious biryani with boiled eggs and spices
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="65"
                        data-name="Egg Biryani"
                        data-price="200"
                        data-image="../images/Egg Biryani.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="seafood">
          <div class="card-image">
            <img src="../images/Fish Biryani.jpg" alt="Fish Biryani" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Fish Biryani" data-lang-ta="மீன் பிரியாணி" data-lang-hi="फिश बिरयानी">Fish Biryani</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="Tender fish pieces in fragrant rice"
               data-lang-ta="வாசனை மிக்க அரிசியில் மென்மையான மீன் துண்டுகள்"
               data-lang-hi="सुगंधित चावल में नरम मछली के टुकड़े">
              Tender fish pieces in fragrant rice
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="66"
                        data-name="Fish Biryani"
                        data-price="350"
                        data-image="../images/Fish Biryani.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="seafood special">
          ...
          <div class="card-image">
            <img src="../images/Prawn Biryani.JPG" alt="Prawn Biryani" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Prawn Biryani" data-lang-ta="இறால் பிரியாணி" data-lang-hi="झींगा बिरयानी">Prawn Biryani</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
            ...
            <p class="card-description" data-lang-en="Juicy prawns layered with spiced rice"
               data-lang-ta="மசாலா அரிசியில் இறால் அடுக்கப்பட்ட சுவை"
               data-lang-hi="मसालेदार चावल में परतदार झींगे">
              Juicy prawns layered with spiced rice
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="67"
                        data-name="Prawn Biryani"
                        data-price="400"
                        data-image="../images/Prawn Biryani.JPG">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
