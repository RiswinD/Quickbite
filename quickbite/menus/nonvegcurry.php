...
<head>
  ...
  <title>QuickBite - Indian Curries & Specials</title>
...
<body>
  ...
  <main class="menu-main curries-main">
    <!-- Hero Section -->
    <div class="menu-hero curries-hero" style="--hero-image: url('../images/curry-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title"
            data-lang-en="Indian Curries & Specials"
            data-lang-ta="இந்திய காரி வகைகள்"
            data-lang-hi="भारतीय करी और स्पेशल">
          Indian Curries & Specials
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Rich, spicy and aromatic curries to delight every palate"
           data-lang-ta="சுவை, வாசனை மற்றும் காரம் நிறைந்த இந்திய காரிகள்"
           data-lang-hi="रसीली, मसालेदार और सुगंधित करी, हर स्वाद के लिए">
          Rich, spicy and aromatic curries to delight every palate
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        ...
        <button class="tab-btn" data-category="mutton">
        ...
        <button class="tab-btn" data-category="chicken special">
      ...
      <div class="menu-grid">
        ...
        <article class="menu-card" data-category="chicken">
          ...
          <div class="card-image">
            <img src="../images/Chicken Curry.jpeg" alt="Chicken Curry" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Chicken Curry" data-lang-ta="கோழி கறி" data-lang-hi="चिकन करी">Chicken Curry</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
            ...
            <p class="card-description" data-lang-en="Spicy chicken in traditional Indian gravy"
               data-lang-ta="பாரம்பரிய இந்திய கிரேவியில் வேக்த்த கோழி"
               data-lang-hi="पारंपरिक ग्रेवी में मसालेदार चिकन">
              Spicy chicken in traditional Indian gravy
            </p>
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-price="250"
                        data-image="../images/Chicken Curry.jpeg">
                  <i class="fas fa-shopping-cart"></i>
        ...
        <!-- Mutton Curry -->
        <article class="menu-card" data-category="mutton">
          <div class="card-image">
            <img src="../images/Mutton Curry.jpg" alt="Mutton Curry" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Mutton Curry" data-lang-ta="மட்டன் கறி" data-lang-hi="मटन करी">Mutton Curry</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
            ...
            <p class="card-description" data-lang-en="Tender mutton cooked with aromatic spices"
               data-lang-ta="மணமுள்ள மசாலா கலந்த மென்மையான மட்டன்"
               data-lang-hi="खुशबूदार मसालों के साथ बना नरम मटन">
            ...
            <div class="card-footer">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="70"
                        data-name="Mutton Curry"
                        data-price="300"
                        data-image="../images/Mutton Curry.jpg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="seafood">
          ...
          <div class="card-content">
            ...
            <p class="card-description" data-lang-en="Tangy and spicy curry with fresh fish"
               data-lang-ta="புளிப்பும் காரமுமுள்ள மீன் குழம்பு"
               data-lang-hi="खट्टी और मसालेदार मछली की करी">
              Tangy and spicy curry with fresh fish
            </p>
            <div class="card-footer">
              <div class="price">
                <span class="current-price">₹275</span>
              </div>
              <div class="add-to-cart">
                <div class="quantity-selector">
                  <button class="qty-btn minus"><i class="fas fa-minus"></i></button>
        ...
        <article class="menu-card" data-category="chicken">
          ...
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Egg Curry" data-lang-ta="முட்டை குழம்பு" data-lang-hi="अंडा करी">Egg Curry</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.5</span>
            ...
            <p class="card-description" data-lang-en="Boiled eggs in spiced onion-tomato gravy"
               data-lang-ta="வெங்காயம் தக்காளி குழம்பில் சுட்ட முட்டைகள்"
               data-lang-hi="प्याज-टमाटर की ग्रेवी में उबले अंडे">
              Boiled eggs in spiced onion-tomato gravy
            </p>
            <div class="card-footer">
              <div class="price">
        ...
        <article class="menu-card" data-category="seafood">
          <div class="card-image">
            <img src="../images/Prawn Curry.jpeg" alt="Prawn Curry" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Prawn Curry" data-lang-ta="இறால் குழம்பு" data-lang-hi="झींगा करी">Prawn Curry</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.7</span>
                <span class="review-count">(195)</span>
              </div>
            </div>
            <p class="card-description" data-lang-en="Juicy prawns cooked in a coconut-based sauce"
               data-lang-ta="தேங்காய் கிரேவியில் இறால் குழம்பு"
               data-lang-hi="नारियल ग्रेवी में बनी स्वादिष्ट झींगा करी">
              Juicy prawns cooked in a coconut-based sauce
            </p>
            <div class="card-footer">
              <div class="price">
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        data-id="73"
                        data-name="Prawn Curry"
                        data-price="350"
                        data-image="../images/Prawn Curry.jpeg">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
