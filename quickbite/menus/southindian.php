...
<head>
  ...
  <title>QuickBite - Breakfast & Tiffin</title>
...
<body>
  ...
  <main class="menu-main breakfast-main">
    <!-- Hero Section -->
    <div class="menu-hero breakfast-hero" style="--hero-image: url('../images/breakfast-bg.jpg')">
      <div class="hero-content">
        <h1 class="hero-title"
            data-lang-en="South Indian Breakfast & Tiffin"
            data-lang-ta="தென் இந்திய காலை உணவு மற்றும் டிபின்"
            data-lang-hi="दक्षिण भारतीय नाश्ता और टिफिन">
          South Indian Breakfast & Tiffin
        </h1>
        <p class="hero-subtitle"
           data-lang-en="Start your day with wholesome and tasty breakfast classics"
           data-lang-ta="உங்கள் நாளை ஆரோக்கியமான மற்றும் சுவையான காலை உணவுகளுடன் தொடங்குங்கள்"
           data-lang-hi="अपने दिन की शुरुआत करें पौष्टिक और स्वादिष्ट नाश्ते से">
          Start your day with wholesome and tasty breakfast classics
        </p>
      </div>
    ...
    <section class="menu-categories">
      <div class="category-tabs">
        ...
        <button class="tab-btn" data-category="breakfast tiffin">
          <i class="fas fa-bread-slice"></i>
          <span data-lang-en="Tiffin" data-lang-ta="டிபின்" data-lang-hi="टिफिन">Tiffin</span>
        </button>
        <button class="tab-btn" data-category="breakfast tiffin special">
          <i class="fas fa-fire"></i>
          <span data-lang-en="Tiffin Special" data-lang-ta="டிபின் சிறப்பு" data-lang-hi="टिफिन स्पेशल">Tiffin Special</span>
        </button>
        <button class="tab-btn" data-category="breakfast special">
          <i class="fas fa-star"></i>
          <span data-lang-en="Specials" data-lang-ta="சிறப்புகள்" data-lang-hi="स्पेशल">Specials</span>
        </button>
        <button class="tab-btn" data-category="breakfast">
          <i class="fas fa-coffee"></i>
          <span data-lang-en="Classic" data-lang-ta="பாரம்பரியம்" data-lang-hi="क्लासिक">Classic</span>
        </button>
      </div>

      <!-- Breakfast/Tiffin Grid -->
      <div class="menu-grid">
        <!-- Idli -->
        <article class="menu-card" data-category="breakfast tiffin">
          <div class="card-badge healthy" data-lang-en="Healthy" data-lang-ta="ஆரோக்கியம்" data-lang-hi="स्वास्थ्य">Healthy</div>
          <div class="card-image">
            <img src="../images/idli.jpg" alt="Idli" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Idli" data-lang-ta="இட்லி" data-lang-hi="इडली">Idli</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.8</span>
            ...
            <p class="card-description" data-lang-en="Steamed rice cakes, soft and healthy"
               data-lang-ta="வாணலியில் வேகவைக்கப்பட்ட மென்மையான இட்லி"
               data-lang-hi="भाप में पके नरम और सेहतमंद चावल के केक">
              Steamed rice cakes, soft and healthy
            </p>
        ...
        <!-- Dosa -->
        <article class="menu-card" data-category="breakfast tiffin special">
          <div class="card-badge popular" data-lang-en="Popular" data-lang-ta="பிரபலமான" data-lang-hi="लोकप्रिय">Popular</div>
          <div class="card-image">
            <img src="../images/Dosa.webp" alt="Dosa" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Dosa" data-lang-ta="தோசை" data-lang-hi="डोसा">Dosa</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.9</span>
            ...
            <p class="card-description" data-lang-en="Crispy rice crepe served with chutney and sambar"
               data-lang-ta="சட்னி மற்றும் சாம்பாருடன் பரிமாறப்படும் தோசை"
               data-lang-hi="चटनी और सांभर के साथ परोसा गया कुरकुरा चावल क्रेप">
        ...
        <!-- Medu Vada -->
        <article class="menu-card" data-category="breakfast tiffin">
          <div class="card-badge crispy" data-lang-en="Crispy" data-lang-ta="மொறுமொறுப்பு" data-lang-hi="कुरकुरा">Crispy</div>
          <div class="card-image">
            <img src="../images/Medu Vada.webp" alt="Medu Vada" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Medu Vada" data-lang-ta="மெது வடை" data-lang-hi="मेदु वड़ा">Medu Vada</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.6</span>
            ...
            <p class="card-description" data-lang-en="Deep-fried lentil fritters, crispy outside, soft inside"
               data-lang-ta="முன்றுப் பருப்பை வைத்து தயாரித்த வெந்த வடை"
               data-lang-hi="गहरे तले हुए दाल के वड़े, बाहर कुरकुरे, अंदर नरम">
              Deep-fried lentil fritters, crispy outside, soft inside
            </p>
            <div class="card-footer">
              <div class="price">
                <span class="current-price">₹50</span>
              ...
              <div class="add-to-cart">
                ...
                <button class="add-cart-btn"
                        ...
                        data-name="Medu Vada"
                        data-price="50"
                        data-image="../images/Medu Vada.webp">
                  <i class="fas fa-shopping-cart"></i>
                  <span data-lang-en="Add" data-lang-ta="சேர்" data-lang-hi="जोड़ें">Add</span>
                </button>
              </div>
        ...
        <article class="menu-card" data-category="breakfast">
          <div class="card-image">
            <img src="../images/Upma.jpeg" alt="Upma" loading="lazy">
          </div>
          <div class="card-content">
            <div class="card-header">
              <h3 data-lang-en="Upma" data-lang-ta="உப்புமா" data-lang-hi="उपमा">Upma</h3>
              <div class="rating">
                <i class="fas fa-star"></i>
                <span>4.5</span>
            ...
            <p class="card-description" data-lang-en="Savory semolina porridge with vegetables"
               data-lang-ta="காய்கறிகளுடன் சேர்க்கப்பட்ட உப்புமா"
               data-lang-hi="सब्जियों के साथ बना नमकीन सूजी का दलिया">
