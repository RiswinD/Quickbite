        ...
        <div class="signup-container">
            ...
            <form method="POST" id="signupForm">
                <div class="form-group">
                    ...
                    <div class="password-hints">4-20 characters, letters, numbers and underscores only</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="password-hints">Minimum 8 characters with at least one uppercase letter and one number</div>
                </div>
                <div class="form-group">
